...
const Topselling: React.FC = () => {
    ...
    return (
      <section className={styles.topselling}>
        <div className="container">
          <div className={styles['topselling__row']}>
            <h2 className={styles['topselling__title']}>New Arrivals</h2>
            <div className={styles['topselling__products']}>
              {[...Array(4)].map((_, i) => (
                <div key={i} className={styles['topselling__skeleton']} />
              ))}
            </div>
          </div>
        </div>
    ...
    return (
      <section className={styles.topselling}>
        <div className="container">
          <div className={styles['topselling__row']}>
            <h2 className={styles['topselling__title']}>New Arrivals</h2>
            <p className={styles['topselling__error']}>{error}</p>
          </div>
        </div>
      </section>
    );
    ...
    return (
      <section className={styles.topselling}>
        <div className="container">
          <div className={styles['topselling__row']}>
            <h2 className={styles['topselling__title']}>New Arrivals</h2>
            <p className={styles['topselling__empty']}>Новых товаров пока нет</p>
          </div>
        </div>
      </section>
    );
  ...
  return (
    <section className={styles.topselling}>
      <div className="container">
        <div className={styles['topselling__row']}>
          <h2 className={styles['topselling__title']}>Top selling</h2>
          ...
          <a href="/shop" className={styles['topselling__view-all']}>
            View All
          </a>
        </div>
      </div>
